...
make_group(group3_v,
	...
	mul_rm2a_b, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v)
...
/* 0xff */
make_group(group5,
	inv, inv, call2_rm_v, inv, 
	jmp2_rm_v, inv, inv, inv)
...
/* 0x14 */	adc_i2a_b, adc_i2a_v, inv, pop_r_v,
/* 0x18 */	sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
/* 0x14 */	sbb_i2a_b, sbb_i2a_v, inv, inv,
...
/* 0x2c */	xor_i2a_b, xor_i2a_v, inv, inv,
...
/* 0x54 */	pop_r_v, pop_r_v, pop_r_v, pop_r_v,
...
/* 0xc0 */	group2_i_b, group2_i_v, ret_w, ret_l,
...
static make_helper(_rep) {
	...
	uint32_t opcode = instr_fetch(eip, 1);
	ops_decoded.opcode = opcode | 0x100;
	return _rep_table[opcode](eip) + 1;
}
